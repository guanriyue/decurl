...
describe('unique', () => {
  ...
  it('creates an identity based array decoder', () => {
    ...
    expect(unique.by((item: { id: number }) => item.id)([itemA, itemB, itemC]))
      .toEqual([itemA, itemC]);
  });
...
describe('shape.datetime', () => {
  it('accepts supported datetime shapes', () => {
    ...
    expect(shape.datetime('2026-06-07T13:45:30')).toBe(
      '2026-06-07T13:45:30',
    );
    expect(shape.datetime('2026-06-07 13:45')).toBe('2026-06-07 13:45');
    expect(shape.datetime('2026-06-07 13:45:30')).toBe(
      '2026-06-07 13:45:30',
    );
    expect(shape.datetime('2026-06-07T13:45:30Z')).toBe(
