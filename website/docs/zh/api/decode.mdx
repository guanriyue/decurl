---
description: '@decurl/react-router/decode 的 API reference。'
---

# @decurl/react-router/decode

`@decurl/react-router/decode` 提供一组可选的 decode primitives。它们用于组合常见字符串解析逻辑，但不是必需品；复杂结构可以直接编写自定义 `decode`。
