---
description: '@decurl/react-router/pagination 的 API reference。'
---

# @decurl/react-router/pagination

`@decurl/react-router/pagination` 提供基于 Search Fields 的分页状态 hook，用于读取和更新 `page`、`pageSize`，并处理分页场景中的常见联动行为。
