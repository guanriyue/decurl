---
description: Decurl 是面向 URL Search Params 的类型安全状态管理库，强调显式 decode、schema 类型推导和 router 集成。
pageType: home
...
features:
  ...
  - title: TypeScript-first
    details: schema 既描述 URL 字段，也推导出 values 类型，让 hook、codec 和业务代码共享同一份约束。
    link: /zh/guide/codec/schema-codec
  - title: Patch encode
  ...
  - title: Alias migration
    details: 读取旧链接中的 legacy key，写回时统一使用 canonical key，帮助 URL schema 平滑演进。
    link: /zh/guide/codec/schema-codec
