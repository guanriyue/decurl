---
description: 'API reference for @decurl/react-router/pagination.'
---

# @decurl/react-router/pagination

`@decurl/react-router/pagination` provides a Search Fields based pagination state hook. It reads and updates `page` and `pageSize`, and handles common pagination coupling behavior.
