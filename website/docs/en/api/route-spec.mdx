---
description: '@decurl/react-router/routeSpec defines path and Search Fields in one place, then generates type-safe in-app hrefs.'
---

# @decurl/react-router/routeSpec

`@decurl/react-router/routeSpec` defines React Router paths and Search Fields in one place, then generates type-safe in-app hrefs from business values.
