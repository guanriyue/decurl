---
description: 'decurl/routeSpec defines path and Search Fields in one place, then generates type-safe in-app hrefs.'
---

# decurl/routeSpec

`decurl/routeSpec` defines React Router paths and Search Fields in one place, then generates type-safe in-app hrefs from business values.
