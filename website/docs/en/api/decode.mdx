---
description: 'API reference for @decurl/react-router/decode.'
---

# @decurl/react-router/decode

`@decurl/react-router/decode` provides optional decode primitives. They compose common string parsing logic, but they are not required; complex structures can use a custom `decode` function directly.
...
```ts
import { mapItems, pipe, shape, toNumber, unique } from '@decurl/react-router/decode';
...
```ts
import { elementOf, pipe, shape, toNumber } from '@decurl/react-router/decode';
...
```ts
import { shape } from '@decurl/react-router/decode';
...
```ts
import { pipe, shape, toBoolean } from '@decurl/react-router/decode';
...
```ts
import { startsWith } from '@decurl/react-router/decode';
...
```ts
import { shape, pipe, toBoolean } from '@decurl/react-router/decode';
...
```ts
import { shape, pipe, toNumber } from '@decurl/react-router/decode';
...
```ts
import { length, pipe, trim } from '@decurl/react-router/decode';
...
```ts
import { max, pipe, shape, toNumber } from '@decurl/react-router/decode';
...
```ts
import { unique } from '@decurl/react-router/decode';
