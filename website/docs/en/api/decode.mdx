...
`decurl/decode` provides optional decode primitives. They compose common string parsing logic, but they are not required; complex structures can use a custom `decode` function directly.
...
```ts
import type { Decode } from 'decurl/decode';
...
```ts
import { mapItems, pipe, shape, toNumber, unique } from 'decurl/decode';
...
```ts
import { elementOf, pipe, shape, toNumber } from 'decurl/decode';
...
```ts
import { shape } from 'decurl/decode';
...
```ts
import { pipe, shape, toBoolean } from 'decurl/decode';
...
```ts
import { startsWith } from 'decurl/decode';
...
```ts
import { shape, pipe, toBoolean } from 'decurl/decode';
...
```ts
import { shape, pipe, toNumber } from 'decurl/decode';
...
```ts
import { length, pipe, trim } from 'decurl/decode';
...
```ts
import { max, pipe, shape, toNumber } from 'decurl/decode';
...
```ts
import { unique } from 'decurl/decode';
