...
If you need to configure store behavior, provide an isolated store, or centralize React Router location access in a separate component, see [Provided Runtime](./provided-runtime).
