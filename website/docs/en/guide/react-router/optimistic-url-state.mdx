---
description: "decurl updates the local search snapshot immediately after user interaction, then flushes it to React Router according to the scheduling strategy."
---
